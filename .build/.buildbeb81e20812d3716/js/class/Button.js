...
Button.prototype.drawImage = function (imgName)
{
	if(this.all.images[imgName] == undefined)
		debugger;
	
	this.all.context.globalAlpha = 1;
	this.all.context.drawImage(this.all.images[imgName], 0,0, this.all.images[imgName].width, this.all.images[imgName].height, this.x, this.y, this.w, this.h);
}
